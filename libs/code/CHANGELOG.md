...
## [0.1.78](https://github.com/sub4biz/deepagents/compare/deepagents-code==0.1.77...deepagents-code==0.1.78) (2026-09-25)
...
* **code:** add durable Debug Console cost breakdown ([#6246](https://github.com/sub4biz/deepagents/issues/6246)) ([c981748](https://github.com/sub4biz/deepagents/commit/c9817483eeea620b1523dcfaed2802269c79d4fe))
...
* **code:** add thread picker ([#6197](https://github.com/sub4biz/deepagents/issues/6197)) ([9d3da12](https://github.com/sub4biz/deepagents/commit/9d3da1287ba5656d52ad7f2c75cf9062d46a4959))
...
* **code:** copy highlighted thread ID with `ctrl+c` ([#6431](https://github.com/sub4biz/deepagents/issues/6431)) ([0a6bd89](https://github.com/sub4biz/deepagents/commit/0a6bd899a0760af76bca025ea6af39997b78e611))
...
* **code:** label plugin servers in the MCP viewer ([#6539](https://github.com/sub4biz/deepagents/issues/6539)) ([d9defc1](https://github.com/sub4biz/deepagents/commit/d9defc124448fed2261b290e060c0cd532b0143a))
...
* **code:** show cache timing in the footer ([#6394](https://github.com/sub4biz/deepagents/issues/6394)) ([f4c226b](https://github.com/sub4biz/deepagents/commit/f4c226b21cc07ee6cee6472ed726f86e69b8af36))
...
* **code:** show human invocations in usage teardown ([#6500](https://github.com/sub4biz/deepagents/issues/6500)) ([0779f31](https://github.com/sub4biz/deepagents/commit/0779f314841ec4216a189b70c615d06194731ecd))
...
* **code:** anchor editable refresh to its checkout ([#6455](https://github.com/sub4biz/deepagents/issues/6455)) ([a6d844d](https://github.com/sub4biz/deepagents/commit/a6d844d47126bb905f30e76569110cd68294a0b3))
...
* **code:** clarify compaction prompt ([#6429](https://github.com/sub4biz/deepagents/issues/6429)) ([15cf630](https://github.com/sub4biz/deepagents/commit/15cf6301e49e00963df876b6697fcc7c42d027d8))
* **code:** clarify thread message count header ([#6428](https://github.com/sub4biz/deepagents/issues/6428)) ([e775680](https://github.com/sub4biz/deepagents/commit/e775680e1cb5a52ba816e6c4663a647a7025d566))
...
* **code:** clean up new sandboxes when setup fails ([#6475](https://github.com/sub4biz/deepagents/issues/6475)) ([1ec8996](https://github.com/sub4biz/deepagents/commit/1ec8996c91fa6f68b3ec8145f279b8c1dea5dc20))
...
* **code:** deduplicate mixed-ID model usage ([#6432](https://github.com/sub4biz/deepagents/issues/6432)) ([bdca132](https://github.com/sub4biz/deepagents/commit/bdca132ee7fbf84ab611392adb6846a1c545d26c))
...
* **code:** diagnose workspace binding and runtime refusals ([#6384](https://github.com/sub4biz/deepagents/issues/6384)) ([f9ffd51](https://github.com/sub4biz/deepagents/commit/f9ffd51154296f81f832f5f184407bc0067acbaf))
...
* **code:** hide unavailable prompt search hints ([#6543](https://github.com/sub4biz/deepagents/issues/6543)) ([3ba4356](https://github.com/sub4biz/deepagents/commit/3ba435604c4b7f664978fa3c5f81914b05d86321))
...
* **code:** keep empty MCP servers searchable and match descriptions ([#6540](https://github.com/sub4biz/deepagents/issues/6540)) ([8d599c9](https://github.com/sub4biz/deepagents/commit/8d599c983e1b5e596d06b2569450dc2411ea8f3f))
* **code:** keep installation locks outside the uv tool directory ([#6472](https://github.com/sub4biz/deepagents/issues/6472)) ([ec128d1](https://github.com/sub4biz/deepagents/commit/ec128d14bd59561e955115c39b8d2a1cdd4dc720))
...
* **code:** keep prompt recall out of file picker ([#6494](https://github.com/sub4biz/deepagents/issues/6494)) ([86b7f85](https://github.com/sub4biz/deepagents/commit/86b7f85af7424ff2491206070897818d71e163cb))
* **code:** keep thread picker resume failures recoverable ([#6476](https://github.com/sub4biz/deepagents/issues/6476)) ([6a41c53](https://github.com/sub4biz/deepagents/commit/6a41c537fb1d4af7a34ef2340fff0f1c088548f4))
...
* **code:** make workspace configuration warnings actionable ([#6546](https://github.com/sub4biz/deepagents/issues/6546)) ([05900e7](https://github.com/sub4biz/deepagents/commit/05900e7ecc14ce64d9535617400a5e2f35d4c734))
...
* **code:** preserve `ask_user` consent receipts across user turns ([#6307](https://github.com/sub4biz/deepagents/issues/6307)) ([ca00490](https://github.com/sub4biz/deepagents/commit/ca004904d1e48385d805d6e3b7f62f82739cfc11))
...
* **code:** preview remote plugin contents before installation ([#6542](https://github.com/sub4biz/deepagents/issues/6542)) ([ec56c57](https://github.com/sub4biz/deepagents/commit/ec56c57fb086dc5bee06547f9896e49a52ead3b3))
...
* **code:** read `hooks.json` as UTF-8 in the legacy hook loader ([#6501](https://github.com/sub4biz/deepagents/issues/6501)) ([61bada8](https://github.com/sub4biz/deepagents/commit/61bada8bcbb62a40bfbe0345831228756f0ba353))
* **code:** reconcile interrupted tool requests ([#6321](https://github.com/sub4biz/deepagents/issues/6321)) ([376e988](https://github.com/sub4biz/deepagents/commit/376e988f98fea5e501050efe250d683259e551f5))
...
* **code:** refresh token and cost breakdown while open ([#6520](https://github.com/sub4biz/deepagents/issues/6520)) ([22524ed](https://github.com/sub4biz/deepagents/commit/22524edb7702d6fb31ffefd2d7d19549b17d2ed6))
...
* **code:** remove contradictory and invalid system-prompt instructions ([#6072](https://github.com/sub4biz/deepagents/issues/6072)) ([2776a66](https://github.com/sub4biz/deepagents/commit/2776a66a955976e4fffbf4cd8612828012feaebc))
...
* **code:** report a mis-encoded `config.toml` from the older config writers ([#6514](https://github.com/sub4biz/deepagents/issues/6514)) ([a6e2140](https://github.com/sub4biz/deepagents/commit/a6e21408ccc1b9a80f941d3458a0ae58dcc29abe))
...
* **code:** resolve plugin MCP servers for login ([#6524](https://github.com/sub4biz/deepagents/issues/6524)) ([ae00358](https://github.com/sub4biz/deepagents/commit/ae00358ed85fb2207cb3ef260d5181a601b5b585))
...
* **code:** restrict auto classifier IDs to the review batch enum ([#6250](https://github.com/sub4biz/deepagents/issues/6250)) ([6152733](https://github.com/sub4biz/deepagents/commit/6152733cbd6b73709a704f3f41b93e2576c5cd52))
* **code:** retry bare `openai.APIError` raised mid-stream ([#6499](https://github.com/sub4biz/deepagents/issues/6499)) ([0f95915](https://github.com/sub4biz/deepagents/commit/0f959156b828f9deb08438b71dbc9a65c13b1714))
...
* **code:** separate access-policy compatibility from runtime identity ([#6386](https://github.com/sub4biz/deepagents/issues/6386)) ([95c7630](https://github.com/sub4biz/deepagents/commit/95c763059fdec12991232fc63418755ba568af74))
...
* **code:** show and handle escape during MCP browser login ([#6541](https://github.com/sub4biz/deepagents/issues/6541)) ([0a1967e](https://github.com/sub4biz/deepagents/commit/0a1967e94c4bce9cb4a28b8368510f3392e9e52b))
...
* **code:** show loading labels for thread details ([#6430](https://github.com/sub4biz/deepagents/issues/6430)) ([5c09b92](https://github.com/sub4biz/deepagents/commit/5c09b9291924df7f67fbc73fda2214a0a50005ea))
* **code:** show session cost warnings in a modal ([#6393](https://github.com/sub4biz/deepagents/issues/6393)) ([c1395da](https://github.com/sub4biz/deepagents/commit/c1395dab009690a30d495bfcae33fb92f62d08c4))
...
* **code:** suppress historical cost warnings on resume ([#6471](https://github.com/sub4biz/deepagents/issues/6471)) ([13170ea](https://github.com/sub4biz/deepagents/commit/13170ea5b07206c94d535141af7e311666f17b7b))
...
* **code:** use UTF-8 for prompts and skill files ([#6474](https://github.com/sub4biz/deepagents/issues/6474)) ([8feaa0f](https://github.com/sub4biz/deepagents/commit/8feaa0fcce7ee967b1411c247d6f4eab202aa66d))
...
* **code:** warm lazy MCP caches off the event loop ([#6517](https://github.com/sub4biz/deepagents/issues/6517)) ([e6419a6](https://github.com/sub4biz/deepagents/commit/e6419a6fbabf18d8232fb6b0a0283bc933b4bae3))
...
* **code:** log thread loading phase timings ([#6490](https://github.com/sub4biz/deepagents/issues/6490)) ([ad038f8](https://github.com/sub4biz/deepagents/commit/ad038f87e07e13791ff9b1e239326d2c959fd412))
...
* **code:** rank checkpoint row IDs before loading blobs ([#6488](https://github.com/sub4biz/deepagents/issues/6488)) ([933eaea](https://github.com/sub4biz/deepagents/commit/933eaeaddea12d1d6fcd0a8cd7716e948ff1df58))
* **code:** rank message row IDs before loading prompts ([#6489](https://github.com/sub4biz/deepagents/issues/6489)) ([17ea378](https://github.com/sub4biz/deepagents/commit/17ea378fcb04f15c916e64eaf24a833b3a63c504))
* **code:** reuse Auto classifier history ([#6056](https://github.com/sub4biz/deepagents/issues/6056)) ([44926fa](https://github.com/sub4biz/deepagents/commit/44926fa8f26dfb24d9a0e3ded335c48b123d193d))
