...
## [0.1.72](https://github.com/sub4biz/deepagents/compare/deepagents-code==0.1.71...deepagents-code==0.1.72) (2026-09-19)
...
* **code:** condense status bar cwd from the middle, tail intact ([#6252](https://github.com/sub4biz/deepagents/issues/6252)) ([f733893](https://github.com/sub4biz/deepagents/commit/f7338933e5ebd6959820023efb66704d6ab8ce7f))
...
* **code:** copy model slug with Ctrl+click ([#6243](https://github.com/sub4biz/deepagents/issues/6243)) ([8a5c317](https://github.com/sub4biz/deepagents/commit/8a5c317e45edb0df4ad42ae79c1c5a6f8cff407f))
...
* **code:** list DeepSeek V4.1 Flash in picker ([#6254](https://github.com/sub4biz/deepagents/issues/6254)) ([0a93587](https://github.com/sub4biz/deepagents/commit/0a9358749d7654cc0bd9273a9e007be89abf316d))
...
* **code:** move MCP onto FastMCP and `langchain.mcp` ([#5922](https://github.com/sub4biz/deepagents/issues/5922)) ([0692ef1](https://github.com/sub4biz/deepagents/commit/0692ef1550568a585afe48705d54a4aa07002697))
...
* **code:** show `read_file` arguments when expanded ([#6392](https://github.com/sub4biz/deepagents/issues/6392)) ([902905f](https://github.com/sub4biz/deepagents/commit/902905f2508fe74dc0ba13d857f502e8ddbc807e))
...
* **code:** show session length in Debug Console ([#6224](https://github.com/sub4biz/deepagents/issues/6224)) ([05edbb1](https://github.com/sub4biz/deepagents/commit/05edbb14d0855303ce74d42a4bf368804856c43a))
...
* **code:** surface locally tracked GitHub stacks ([#6290](https://github.com/sub4biz/deepagents/issues/6290)) ([c08cae6](https://github.com/sub4biz/deepagents/commit/c08cae693e0036fcd45d979a7dfa3a7e306a0515))
...
* **code:** align file and console debug log formatting ([#6426](https://github.com/sub4biz/deepagents/issues/6426)) ([6c219d3](https://github.com/sub4biz/deepagents/commit/6c219d3a39a869b55c5ec434acf76f84217eb002))
* **code:** align prompt clipboard word deletion ([#6345](https://github.com/sub4biz/deepagents/issues/6345)) ([777d633](https://github.com/sub4biz/deepagents/commit/777d6336de3c7f1b6759a3f092fbfeddc4c54499))
...
* **code:** attribute dotenv config sources ([#6222](https://github.com/sub4biz/deepagents/issues/6222)) ([6f1ac85](https://github.com/sub4biz/deepagents/commit/6f1ac85c46604ef093a9d295fbcc52a8108aa8ed))
...
* **code:** clarify unknown effort default ([#6337](https://github.com/sub4biz/deepagents/issues/6337)) ([5ee1073](https://github.com/sub4biz/deepagents/commit/5ee1073e9ab2fe9a286becb27ec7e694a4b3de4f))
...
* **code:** deduplicate footer picker clicks ([#6344](https://github.com/sub4biz/deepagents/issues/6344)) ([811e927](https://github.com/sub4biz/deepagents/commit/811e92738ffa491e991b9dea6573fff57a84d938))
...
* **code:** delay hook status in footer ([#6322](https://github.com/sub4biz/deepagents/issues/6322)) ([7f9e8ed](https://github.com/sub4biz/deepagents/commit/7f9e8ed3a555933902045792da9bb184950ee7b2))
...
* **code:** drop stale Anthropic thinking blocks ([#6300](https://github.com/sub4biz/deepagents/issues/6300)) ([fe01fac](https://github.com/sub4biz/deepagents/commit/fe01fac1fa3c4d30d9379a9e5f4273a622710049))
...
* **code:** expose unknown reasoning effort ([#6241](https://github.com/sub4biz/deepagents/issues/6241)) ([ed715ee](https://github.com/sub4biz/deepagents/commit/ed715eeba608af47c9ed7943822c25d935a30b9e))
...
* **code:** isolate user shell tracing credentials ([#6242](https://github.com/sub4biz/deepagents/issues/6242)) ([35c21fa](https://github.com/sub4biz/deepagents/commit/35c21faafe329f4f6932c0941d163306e1aa06e5))
* **code:** keep absolute paths in normal input mode ([#6379](https://github.com/sub4biz/deepagents/issues/6379)) ([141ce98](https://github.com/sub4biz/deepagents/commit/141ce9851b876f733ef390ead3edbc509536a8e8))
...
* **code:** open debug console at log bottom ([#6218](https://github.com/sub4biz/deepagents/issues/6218)) ([34f1b6b](https://github.com/sub4biz/deepagents/commit/34f1b6b037b24a1f2fe8b1d6112d9f8cdfe32bf2))
* **code:** order debug console log filters ([#6217](https://github.com/sub4biz/deepagents/issues/6217)) ([4bbad10](https://github.com/sub4biz/deepagents/commit/4bbad10385b22cb76dc40aaa4709d4726f20db02))
...
* **code:** pin resumed history to newest message ([#6225](https://github.com/sub4biz/deepagents/issues/6225)) ([9b5ca38](https://github.com/sub4biz/deepagents/commit/9b5ca384ff727f16c4f66a13308170cfba899b97))
...
* **code:** price nested usage with its own model and honor completions ([#6251](https://github.com/sub4biz/deepagents/issues/6251)) ([f413a40](https://github.com/sub4biz/deepagents/commit/f413a40f7e74ada749b18491aa276ee1224c7368))
...
* **code:** replace composer with prompt search and prevent query feedback ([#6346](https://github.com/sub4biz/deepagents/issues/6346)) ([a52ecea](https://github.com/sub4biz/deepagents/commit/a52ecea1f4b159a5ec0c667c6d05e26ea701db30))
...
* **code:** scroll overflowing chat input pastes ([#6382](https://github.com/sub4biz/deepagents/issues/6382)) ([b522fd4](https://github.com/sub4biz/deepagents/commit/b522fd4a74b2349b25f3f1f630265f7e456430ee))
...
* **code:** show the spinner during pre-stream turn setup ([#6253](https://github.com/sub4biz/deepagents/issues/6253)) ([fa609c2](https://github.com/sub4biz/deepagents/commit/fa609c23ba883557d015529d431ae266847e388c))
...
* **code:** silence non-media path decoder traces ([#6427](https://github.com/sub4biz/deepagents/issues/6427)) ([3693e9d](https://github.com/sub4biz/deepagents/commit/3693e9d01a94a4e881cbb5f92438adfec27cd77e))
...
* **code:** wrap debug logs before the scrollbar ([#6219](https://github.com/sub4biz/deepagents/issues/6219)) ([ca7999a](https://github.com/sub4biz/deepagents/commit/ca7999a8a9984e110a3b80d2e5f71dbe895f58ec))
...
* **code:** skip transcript scan on prompt submit ([#6402](https://github.com/sub4biz/deepagents/issues/6402)) ([443d34b](https://github.com/sub4biz/deepagents/commit/443d34bfde4f22cbc7f9ac71be766922a041e08c))
