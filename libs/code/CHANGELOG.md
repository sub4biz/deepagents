...
## [0.1.69](https://github.com/sub4biz/deepagents/compare/deepagents-code==0.1.68...deepagents-code==0.1.69) (2026-09-13)
...
* **code:** add `GPT-6 Astra` support ([#6141](https://github.com/sub4biz/deepagents/issues/6141)) ([048f989](https://github.com/sub4biz/deepagents/commit/048f9890bfe8b640e1e72085a4fa50d9084545f0))
...
* **code:** limit thread resume age ([#6068](https://github.com/sub4biz/deepagents/issues/6068)) ([318311f](https://github.com/sub4biz/deepagents/commit/318311f56c3d3b9c4af4ece22fcfc387eeece5cc))
...
* **code:** recommend GLM 5.3 models ([#6211](https://github.com/sub4biz/deepagents/issues/6211)) ([e7e88d5](https://github.com/sub4biz/deepagents/commit/e7e88d5efaf2bbce33237ea323fb68487eabd721))
...
* **code:** reuse server across workspace switches ([#6152](https://github.com/sub4biz/deepagents/issues/6152)) ([ca2d1ef](https://github.com/sub4biz/deepagents/commit/ca2d1ef7f270d0fa1040e5473f43e99937b5f03f))
...
* **sdk,code:** update `read_file` output formatting ([#5648](https://github.com/sub4biz/deepagents/issues/5648)) ([276beca](https://github.com/sub4biz/deepagents/commit/276becae1bbaa38d6253aee90e99212e7bdf0606))
...
* **code:** confirm server restart for workspace switch ([#6178](https://github.com/sub4biz/deepagents/issues/6178)) ([7997203](https://github.com/sub4biz/deepagents/commit/7997203245915aa83e87db83252c04391bd00440))
...
* **code:** demote no-output hint suppression to debug ([#6245](https://github.com/sub4biz/deepagents/issues/6245)) ([d93ab33](https://github.com/sub4biz/deepagents/commit/d93ab3351bbf4c3687212f665094ccad100f2c08))
...
* **code:** isolate LangSmith auth and workspace tracing ([#6061](https://github.com/sub4biz/deepagents/issues/6061)) ([794eda8](https://github.com/sub4biz/deepagents/commit/794eda83b777a2a7278e5726607e4b305801298d))
...
* **code:** offload server config import ([#6089](https://github.com/sub4biz/deepagents/issues/6089)) ([90fe4f4](https://github.com/sub4biz/deepagents/commit/90fe4f4ac0a1311f1527b1a5cd02bd3ac8664580))
...
* **code:** parse extra skill dirs with platform separator ([#6151](https://github.com/sub4biz/deepagents/issues/6151)) ([56e4ef1](https://github.com/sub4biz/deepagents/commit/56e4ef1a5f447950a04ba37a7855c8e0babd2f11))
...
* **code:** price Fireworks GLM-5.3 Flash usage ([#6223](https://github.com/sub4biz/deepagents/issues/6223)) ([d3627ea](https://github.com/sub4biz/deepagents/commit/d3627eaaeda2de62c19b0647ac29f80767057241))
* **code:** price Fireworks GLM-5.3 usage ([#6221](https://github.com/sub4biz/deepagents/issues/6221)) ([07c5d2e](https://github.com/sub4biz/deepagents/commit/07c5d2ecfe5db6238eff782f714fbbe08865e8d4))
...
* **code:** resolve project policy per workspace ([#6064](https://github.com/sub4biz/deepagents/issues/6064)) ([ea1f253](https://github.com/sub4biz/deepagents/commit/ea1f2536537efb01c71dce54c46894b9318c4f80))
...
* **code:** run sandbox creation and entry off the guarded event loop ([#6017](https://github.com/sub4biz/deepagents/issues/6017)) ([fd28bfb](https://github.com/sub4biz/deepagents/commit/fd28bfb5c5e1ca18af975d8e57d361c1c23f81b7))
...
* **code:** serialize transcript tail reconciliation ([#6143](https://github.com/sub4biz/deepagents/issues/6143)) ([5fb8b69](https://github.com/sub4biz/deepagents/commit/5fb8b699843ecf93debc592d9dbb8a534f54db09))
...
* **code:** silence absent themes config warning ([#6220](https://github.com/sub4biz/deepagents/issues/6220)) ([b93f748](https://github.com/sub4biz/deepagents/commit/b93f7483bb5722bbae281a19a80a7aea21d38832))
...
* **code:** standardize recent-thread environment variable ([#6205](https://github.com/sub4biz/deepagents/issues/6205)) ([a4c218e](https://github.com/sub4biz/deepagents/commit/a4c218e185bc49a11a381c3afde91f6efa7226fc))
...
* **code:** surface stale updates in-session ([#6063](https://github.com/sub4biz/deepagents/issues/6063)) ([cdb9d4c](https://github.com/sub4biz/deepagents/commit/cdb9d4c30f4419c0eb2c98ad53940875e4dfbe9e))
* **code:** surface the LangSmith credential in `dcode config` ([#6083](https://github.com/sub4biz/deepagents/issues/6083)) ([a1a0887](https://github.com/sub4biz/deepagents/commit/a1a0887f7e42d0f8515ad415c9b9062e89350e8c))
...
* **code:** treat effort changes as cache identity for OpenAI and Anthropic ([#6196](https://github.com/sub4biz/deepagents/issues/6196)) ([cacd50a](https://github.com/sub4biz/deepagents/commit/cacd50adc365e949e4f0b9a7e94ad6f8eeb7d497))
